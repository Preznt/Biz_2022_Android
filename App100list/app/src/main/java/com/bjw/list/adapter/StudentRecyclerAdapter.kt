package com.bjw.list.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import android.widget.TextView
import androidx.recyclerview.widget.RecyclerView
import com.bjw.list.databinding.StudentListItemBinding
import com.bjw.list.models.StudentDto

/**
 * Adapter 클래스
 * 복잡한 UI 구현하거나,
 * 복잡한 연산을 수행할때 기본 코드만으로 구현이 어려운 부분이 많다
 * 안드로이드에서는 데이터를 RecyclerView 에 표현할때
 * 여러가지 잡다한 설정을 겁나게 해야한다.
 ...
 * 이 3개의 함수를 통하여 RecyclerView 의 item 들을 화면에 표시 할 수 있다
 *
