 ...
 *  이미 제공해주는 라이브러리의 다른 class 의 기능을 상속받아 사용해야 하기 때문에
...
class MainActivity : AppCompatActivity() {
     ...
     * 이 method는 원래 AppCompatActivity class 에 정의(선언) 되어있는
     *      method 이다. 이 method 를 자신의 App 프로젝트에서
     *      다시 코드를 작성하여 자신의 App 이 작동되도록 만드는 것이다
     * 이것을 method 의  재 정의(override)라고 한다.
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        // super 객체의 onCreate() method 를 호출(사용,실행)하는 코드
        // super 객체는 AppCompatActivity 클리스를 가리키고 있다
        ...
        // activity_main.xml에 만들어진 TextView 와 Button을 코드에서 사용하기
        ...
        // main.xml 에 설정된 txt1 id의 view 를 가져와서 변수에 할당(저장, 보관)
        val txt1:TextView = findViewById(R.id.txt1)
        // findViewById 에게 지금 R.id.txt1은 TextView type의 view 라는 것을 알려주고
        ...
        // setOnClickListener( { it -> 주저리주저리} )
        btnClick1.setOnClickListener{
            // it이라는 변수는 View 라는 타입
            // Toast Message
            ...
            Snackbar
                .make(it, // 어디에, 자동으로 Callback 함수의 매개변수로 설정되어 있다.
                    "나는 스넥바", // 무엇을
        ...
        // MainActivity.onCreate() 함수를 scope로 갖는 변수이다
        var count = 0
        ...
        btnClick3.setOnClickListener{
            ...
            val newActivityIntent = Intent(
                ...
                // 새로운 Activity 에게 어떤 값을 전달하고자 할때
                // username 이라는 변수를 생성하고 bjw 라는 문자열을 담아서 전달하기
                putExtra("username","bjw")
                putExtra("age", 33)
            }
        ...
        val edit1 = findViewById<EditText>(R.id.edit_txt1)
        val edit2 = findViewById<EditText>(R.id.edit_txt2)
