...
import com.bjw.game.databinding.ActivityMainBinding
import com.bjw.game.ui.FRAGMENT_MAIN
import com.bjw.game.ui.FRAGMENT_RESULT
import com.bjw.game.ui.MainFragment
import com.bjw.game.ui.ResultFragment
...
class MainActivity : AppCompatActivity() {
     ...
     * Activity 아래의 다수의 Fragment 가 서로 화면을 교화하고자 할때
     * Fragment 들 간은 형제간 이기 때문에 형제끼리 교환이 불가능 하다
     * 이때는 Activity 에 Fragment 를 교환(Replace) 할 수 있는 함수를 만들어 두고
    ...
    fun changeFragment(fragmentName: String){
         ...
         * 하지만 함수를 호출하는 곳에서 문자열 중에 글자를 빼먹거나
         * 대소문자를 잘못사용하면 null이 될 것 이다
         */
//        if(fragment != null){
