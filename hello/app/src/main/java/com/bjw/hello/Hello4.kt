...
fun main() {
    ...
    // Math.random() 0부터 1미만의 난수 발생
    // 100 곱하면 0부터 99까지 난수 생성
    // 1을 더하면 1붙어 100까지 난수 생성
    ...
    println("${strNation} 에는 Korea 문자열이 포함 ${if(yesNo) "되어있음" else "되지 않음"}")
