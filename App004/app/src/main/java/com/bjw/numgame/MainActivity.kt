package com.bjw.numgame

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.bjw.numgame.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
     ...
     * 하지만 경우에 따라 선언부와 초기화 코드를 분리하고자 할때
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // binding으로 연결된 layout / *.xml 파일을 화면에 그려라
        ...
        binding.txtNumber.setOnEditorActionListener{view,keyCode, evnet ->
            // input 입력된 문자열 추출
            ...
            // EditorActionListener 이벤트를 설정하지 않으면
            // enter 를 클릭했을때 자동으로 키보다가 감춰진다
            // EditActionListener 이벤트를 설정하고 제일 마지막에서
            // 일반적으로 true(return true) 를 사용하는데
            // true를 return 하는것은 키보드 상태를 그대로 유지하라 라는 표현
            // 키보드가 화면에 보이는 상태에서는 Snack bar를 표시할 수 없다
            // Snack bar를 보이게 하기 위핸서는 끝에서 false를 사용한다
            ret
        }
    }
}